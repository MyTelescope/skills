...
- Colors: `#00CCFF` for positive, `#FF6B6B` for negative, `#323F5F` for neutral. For multi-series, use the 20-color palette in order (see `## Visual Rendering` at the bottom of this file).
...
**Full visual spec:** see `## Visual Rendering` at the bottom of this file, or fetch the MCP prompt `style_guide`.
